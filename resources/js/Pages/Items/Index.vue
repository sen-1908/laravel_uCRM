                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">test
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </a>
                                <Link as="button" :href="route('items.create')" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">create</Link>
